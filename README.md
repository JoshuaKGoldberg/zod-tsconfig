...
<!-- ALL-CONTRIBUTORS-BADGE:END -->
	...
	<a href="https://codecov.io/gh/JoshuaKGoldberg/zod-tsconfig" target="_blank"><img alt="🧪 Coverage" src="https://img.shields.io/codecov/c/github/JoshuaKGoldberg/zod-tsconfig?label=%F0%9F%A7%AA%20coverage" /></a>
...
```ts
import { greet } from "zod-tsconfig";
